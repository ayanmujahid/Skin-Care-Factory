                    ...
                    <div class="card-body p-20">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <div>
                                ...
                                <h6 class="mb-0">{{ $newsletters->count() }}</h6>
                            </div>
                            <div
                    ...
                    <div class="card-body p-20">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <div>
                                ...
                                <h6 class="mb-0">${{ number_format($totalIncome, 2) }}</h6>
                            </div>
                            <div
            ...
            <div class="card h-100 radius-8 border">
                <div class="card-body p-24">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-20">
                        <h6 class="fw-semibold mb-0">{{ number_format($totalSubscribers) }}</h6>
                    ...
                    <ul class="d-flex flex-wrap align-items-center justify-content-between mt-3 gap-3">
                        <li class="d-flex align-items-center gap-2">
                            ...
                            <span class="text-secondary-light text-sm fw-normal">New:
                                New:
                                <span class="text-primary-light fw-semibold">{{ $newUsers }}</span>
                            </span>
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            ...
                            <span class="text-secondary-light text-sm fw-normal">Subscribed:
                                Subscribed:
                                <span class="text-primary-light fw-semibold">{{ $totalSubscribers }}</span>
                            </span>
                        </li>
                    </ul>
                        ...
                        <ul class="nav border-gradient-tab nav-pills mb-0" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-flex align-items-center active" id="pills-to-do-list-tab"
                                    ...
                                    Latest Registered
                                    <span
                                        class="text-sm fw-semibold py-6 px-12 bg-neutral-500 rounded-pill text-white line-height-1 ms-12 notification-alert">{{ $users->count() }}</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link d-flex align-items-center" id="pills-recent-leads-tab"
                                    ...
                                    Latest Subscribe
                                    <span
                                        class="text-sm fw-semibold py-6 px-12 bg-neutral-500 rounded-pill text-white line-height-1 ms-12 notification-alert">{{ $newsletters->count() }}</span>
                                </button>
                            </li>
                        </ul>
                                        ...
                                        @forelse($newsletters as $newsletter)
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            {{-- <h6 class="text-md mb-0 fw-medium">{{ $newsletter->name }}</h6> --}}
                                                            <span class="text-sm text-secondary-light fw-medium">
                                                                {{ $newsletter->email }}
                                                            </span>
                                                        </div>
