...
@endphp
        ...
        <div class="dropdown">
          <button class="d-flex justify-content-center align-items-center rounded-circle" type="button"
            ...
            <img src="{{asset('admin/images/avatar/user-icon-image.png')}}" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">
          </button>
          <div class="dropdown-menu to-top dropdown-menu-sm">
            <div
              class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
              <div>
                <h6 class="text-lg text-primary-light fw-semibold mb-2"> {{ $admin->name ?? 'Admin' }}</h6>
                <span class="text-secondary-light fw-medium text-sm">{{ $admin->role ?? 'Administrator' }}</span>
              </div>
