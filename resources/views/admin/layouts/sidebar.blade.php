          ...
          <li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="wizard.html"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Form
                            Wizard</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="gallery-grid.html"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                            Gallery
                            Grid</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="gallery-hover.html"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>
                            Gallery Hover
                            Effect</a>
                    </li>
                </ul>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="add-blog.html"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Add
                            Blog</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="bad-request.html"><i class="ri-circle-fill circle-icon text-danger-600 w-auto"></i>
                            Bad
                            Request</a>
                    </li>
                    <li>
                        <a href="forbidden.html"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>
                            Forbidden</a>
                    </li>
                    <li>
                        <a href="error.html"><i class="ri-circle-fill circle-icon text-warning-600 w-auto"></i> 404
                            Page</a>
                    </li>
                    <li>
                        <a href="internal-server.html"><i
                                class="ri-circle-fill circle-icon text-primary-main w-auto"></i>
                            Internal
                            Server</a>
                    </li>
                    <li>
                        <a href="service-unavailable.html"><i
                                class="ri-circle-fill circle-icon text-danger-main w-auto"></i>
